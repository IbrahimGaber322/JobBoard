  ...
  <div  class="container mx-auto py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="job in jobs" :key="job.id">
        <div v-if="isOwner || job.status === 'accepted'" class="bg-white rounded-lg shadow-md overflow-hidden p-6 flex flex-col justify-between items-center"> <!-- Adjusted flex properties -->
