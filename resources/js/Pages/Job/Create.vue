<template>
      ...
      <GuestLayout>
        ...
        <form @submit.prevent="submitForm" class="max-w-xl mx-auto">
          ...
          <div class="mb-6">
            ...
            <InputError class="mt-2" :message="form.errors.title" v-if="form.errors.title" />
  
          </div>
  
          <div class="mb-6">
            <InputLabel for="desc" value="Description" />
            <textarea id="desc" class="mt-1 block w-full tall-input" v-model="form.desc" ></textarea>
            <InputError class="mt-2" :message="form.errors.desc" v-if="form.errors.desc"/>
          </div>
  
          <div class="mb-6">
            <InputLabel for="responsibilities" value="Responsibilities" />
            <textarea id="responsibilities" class="mt-1 block w-full tall-input" v-model="form.responsibilities"
              ></textarea>
          ...
          <div class="mb-6">
            ...
            <textarea id="skills" class="mt-1 block w-full tall-input" v-model="form.skills" ></textarea>
          </div>
  
          <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
              <InputLabel for="experience_level" value="Experience Level" />
              <TextInput id="experience_level" type="text" class="mt-1 block w-full"  v-model="form.experience_level" />
            ...
            <div>
              ...
              <InputError class="mt-2" :message="form.errors.salary_range" v-if="form.errors.salary_range" />
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div>
              ...
              <InputError class="mt-2" :message="form.errors.company_name" v-if="form.errors.company_name"/>
          ...
          <div class="mb-6">
            ...
            <input id="deadline" type="date" class="mt-1 block w-full" v-model="form.deadline" :min="today" />
            <InputError class="mt-2" :message="form.errors.deadline" v-if="form.errors.deadline"/>
          </div>
          <div>
  ...
  function validateDeadline() {
    ...
    if (selectedTimestamp < currentTimestamp) {
      deadlineError = 'Please select a future date for the deadline.';
    } else {
      deadlineError = '';
    }
  }
